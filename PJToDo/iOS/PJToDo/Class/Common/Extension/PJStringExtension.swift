...
public extension String {
    static func create(cString: UnsafeMutablePointer<Int8>, encoding: String.Encoding = .utf8) -> String {
    ...
    static func convertToBase64String(str: String, encoding: String.Encoding = .utf8) -> String {
